...
import top.ityf.mybatis.annotations.*;
...
public class XMLConfigBuilder {
        ...
        try {
            ...
            for (Element mapperElement : mapperElements) {
                ...
                if (attribute != null) {
                    ...
                    //取出属性的值
                    //获取属性的值"top/ityf/dao/UserDao.xml"
    ...
    /**
     * 根据传入的参数，得到dao中所有被select注解标记的方法
     * 根据方法名和类名，以及方法上注释value属性的值，组成 Mapper 的必要信息
     *
     * @param daoClassPath
     * @return
     */
